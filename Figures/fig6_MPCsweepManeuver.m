...
basepath = '../MPC/Results_211117_17_03_27'; 
...
plot(c5.tHistory,c5.CL_ref(1:c5.Nt),'-','Color',[0 0 0 0.6],'Linewidth',2); hold on
...
ylabel('$C_L$')
xlim([0 t_end])
ylim([min(c1.yHistory(1,:))-0.05 max(c1.yHistory(1,:))+0.05])
...
% print('f_MPC_constraint11','-depsc')
